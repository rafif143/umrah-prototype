<script>
	...
	let roomTypes = $state([
		...
		{ id: 3, label: 'Triple', value: 'triple' },
		{ id: 4, label: 'Quad', value: 'quad' },
		{ id: 5, label: 'Quint', value: 'quint' },
		{ id: 6, label: 'Sharing', value: 'sharing' }
	]);
	...
	let hotelViews = $state([
		{ id: '1', name: 'Kaaba View' },
		{ id: '2', name: 'Haram View' },
		{ id: '3', name: 'City View' },
		{ id: '4', name: 'No View' }
	]);
					...
					<div class="flex flex-col gap-6">
						{#if activeTab === 'general'}
							...
							<div class="rounded-xl border border-gray-200 bg-white p-6">
								<h2 class="mb-5 text-base font-semibold text-gray-900">
									General Information Hotel
								</h2>
						...
						{#if activeTab === 'cp'}
							...
							<div class="rounded-xl border border-gray-200 bg-white p-6">
								...
								<div class="grid grid-cols-2 gap-5">
									...
									<div class="flex flex-col gap-1.5">
										<label for="cpMobile" class="text-[13px] font-medium text-gray-700"
											>Mobile</label
										>
										<input
											type="tel"
